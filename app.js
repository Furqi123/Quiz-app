    ...
    <div class="sign-up">
      ...
      <div class="sign-up-body">
        ...
        <div class="sign-up-btn">
          <button onclick="quizStart()">Login</button>
        </div>
...
//     var main = document.getElementById('main')
//     main.innerHTML = `
//     <div class="quiz-selection" id="quiz-select">
//     <div class="row">
//       <div class="quiz-box col-4">
//         <div onclick = "press()" class="animate__animated animate__fadeInDown card">
//           <div class="card-body">
//           <h2>HTML</h2>
//           <p>Each Question Time: 20sec</p>
...
// function press(){
//  var quizSelection = document.getElementById('quiz-select')
...
if(!htmlQuestions[htmlIndex]){
 ...
 <div class="result-btn">
  ...
  <button onclick="loginPage()">Quit Quiz</button>
  ...
  <div class="box" id="quiz-question">
    ...
    <div class="box-body">
      ...
      <p class="ques">${count++}) ${htmlQuestions[htmlIndex].question}</p>
      <div>
        <label for=""><input type="radio" name="option" value="${htmlQuestions[htmlIndex].option1}" id="">${htmlQuestions[htmlIndex].option1}</label>
      </div>
      <br>
      <div>
        <label for=""><input type="radio" name="option" value="${htmlQuestions[htmlIndex].option2}" id="">${htmlQuestions[htmlIndex].option2}</label>
      </div>
      <br>
      <div>
        <label for=""><input type="radio" name="option" value="${htmlQuestions[htmlIndex].option3}" id="">${htmlQuestions[htmlIndex].option3}</label>
      </div>
      <br>
      <div>
        <label for=""><input type="radio" name="option" value="${htmlQuestions[htmlIndex].option4}" id="">${htmlQuestions[htmlIndex].option4}</label>
      </div>
      <div>
        <button onclick="quizStart()" class="box-btn">Next</button>
      </div>
    </div>
  </div> 
`
