    ...
    <div id="sign-up" class="sign-up">
      ...
      <div class="sign-up-body">
        ...
        <div class="sign-up-btn">
          <button onclick="quizSelect()">Login</button>
        </div>
  ...
  main.innerHTML = `
    ...
    <div class="row">
      <div class="quiz-box col-4">
        <div class="animate__animated animate__fadeInDown card">
          <div class="card-body">
          <h2>HTML</h2>
          <p>Each Question Time: 20sec</p>
          <p>Total Question: 10</p>
          <p>Each Question: 10 Marks</p>
          <p>Level: Basic</p>
          <button onclick="pressHtml()" class="box-btn">Start Quiz</button>
          </div>
         </div>
      </div>
      ...
      <div class="quiz-box col-4">
        <div onclick = "press()" class="animate__animated animate__fadeInDown card">
          ...
          <p>Each Question: 10 Marks</p>
          <p>Level: Basic</p>
          <button class="box-btn">Start Quiz</button>
          </div>
         </div>
      </div>
    ...
    <div class="box" id="quiz-question">
      ...
      <p class="ques">${quesCount++}) ${htmlQuestions[htmlIndex].question}</p>
        ...
        <div>
          ...
          <div>
          <button disabled id="btn" onclick="pressHtml()" class="box-btn">Next</button>
        </div>
        </div>
    </div>
    `
